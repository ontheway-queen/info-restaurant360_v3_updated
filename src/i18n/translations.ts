...
export const translations = {
  en: {
    ...
    homeSections: {
      ...
      featuresSub: "One platform for billing, kitchen, inventory, accounts and settlement.",
    ...
    modules: [
      { title: "Dashboard", desc: "Real-time business snapshot at a glance." },
      { title: "Point of Sale (POS)", desc: "Fast and flexible billing for any outlet type." },
      { title: "Table-based POS", desc: "Manage dine-in orders linked to tables." },
      { title: "Non-table POS", desc: "Continuous billing for takeaway and counter sales." },
      { title: "Order Management", desc: "Track pending, ongoing and completed orders." },
      { title: "Table Management", desc: "Create, update and monitor table status." },
      { title: "Kitchen / KOT", desc: "Send and track orders inside the kitchen." },
      { title: "Ongoing Orders", desc: "Live view of all in-progress orders." },
      { title: "Food Management", desc: "Manage food items, pricing and availability." },
      { title: "Menu Categories", desc: "Organize menu by category for fast selection." },
      { title: "Prepared Food", desc: "Track ready-to-serve prepared items." },
      { title: "Add-ons", desc: "Toppings, extras and customization support." },
      { title: "Inventory", desc: "Stock in/out and real-time stock visibility." },
      { title: "Raw Materials", desc: "Manage products and raw material details." },
      { title: "Purchases", desc: "Record and track all restaurant purchases." },
      { title: "Stock Management", desc: "Control stock movement and adjustments." },
      { title: "Inventory Overview", desc: "See total stock health in one screen." },
      { title: "Supplier Management", desc: "Manage suppliers and procurement." },
      { title: "HR Management", desc: "Manage employees, roles and access." },
      { title: "Accounts & Finance", desc: "Income, expense and full financial control." },
      { title: "Cash Management", desc: "Track cashier-wise daily collection." },
      { title: "Bank Management", desc: "Track bank deposits and balances." },
      { title: "Payment Methods", desc: "Cash, card, bank and gateway support." },
      { title: "Settlement", desc: "Cash, bank and gateway settlement control." },
      { title: "Reports & Analytics", desc: "Sales, inventory and finance reports." },
      { title: "Administration", desc: "Roles, permissions and system setup." },
    ],
    why: {
      ...
      benefits: [
        ...
        "Track sales clearly",
        "Verify cash and bank collection",
        "Manage staff and roles",
        "Improve business visibility",
      ],
      cta: "Run Your Restaurant with Complete Control",
    },
    dashboard: {
      heading: "Real-time Restaurant Dashboard",
      sub: "A live snapshot of your entire restaurant in one place.",
      features: [
        "Real-time sales analytics",
        "Daily sales summary",
        "Detailed order insights",
        "Order status overview",
        "Item-wise revenue tracking",
        "Product stock visibility",
        "Sales quantity tracking per item",
        "Cash collection summary",
        "Pending settlement summary",
        "Quick operational snapshot for decision-making",
      ],
    },
    pos: {
      heading: "Fast POS Billing for Every Restaurant",
      ...
      capabilities: [
        ...
        "Cash, card, bank and gateway support",
      ],
    },
    orderManagement: {
      heading: "Complete Order Lifecycle Management",
      sub: "From the first tap to the final payment — every order tracked.",
      features: [
        "POS-integrated order view",
        "Pending, ongoing and completed order filtering",
        "Table-wise order tracking",
        "Active order modification",
        "Add/remove items before completion",
        "Payment processing",
    ...
    kitchenKot: {
      ...
      features: [
        ...
        "Kitchen display style interface",
        "Reduce communication errors",
        "Improve service speed",
        "Track preparing, ready and served status",
      ],
    },
    foodManagement: {
      heading: "Food, Menu and Add-on Management",
      sub: "Structure your menu the way your restaurant operates.",
      features: [
        "Food item CRUD",
        ...
        "Add-ons and extras",
        "Flexible toppings and customization",
        "Easy menu structuring",
      ],
    },
    inventory: {
      heading: "Smart Inventory and Stock Control",
      sub: "Track every raw material from purchase to plate.",
      features: [
    ...
    accounts: {
      ...
      sub: "Connect sales, purchases and payments to your finance in real time.",
      features: [
        "Income tracking",
        "Expense tracking",
        ...
        "Card / gateway collection tracking",
        "Payment method-wise summary",
        "Cash handover",
        "Bank deposit tracking",
        "Gateway settlement",
        "Settlement batch management",
        "Settlement charge tracking",
        "Daily closing settlement",
      ],
    },
    settlement: {
      heading: "Cash, Bank & Settlement Control",
      sub: "RESTAURANT360 helps restaurants track daily cash collection, bank payments, card/gateway payments and settlement status clearly. Managers can verify cash, bank and online payment collections before closing daily operations.",
      features: [
        "Cash collection tracking",
        "Bank payment tracking",
        "Card payment tracking",
        "Mobile banking / gateway payment tracking",
        "Payment method-wise collection summary",
        "Cash handover tracking",
        "Cash vs system collection verification",
        "Bank deposit tracking",
        "Gateway settlement tracking",
        "Pending settlement list",
        "Settled payment list",
        "Settlement batch management",
        "Settlement date tracking",
        "Reference number tracking",
        "Bank charge / gateway charge tracking",
        "Daily closing settlement summary",
        "Cashier-wise settlement report",
        "Payment method-wise settlement report",
    ...
    reports: {
      ...
      sub: "All the numbers you need, when you need them.",
      list: [
        "Daily sales report",
        "Monthly sales report",
        "Custom date range sales report",
        "Product performance report",
        "Item-wise sales quantity report",
        "Inventory report",
        "Purchase report",
        "Supplier report",
        "Financial summary",
        ...
        "Payment method-wise collection report",
    ...
    administration: {
      heading: "Administration and System Control",
      sub: "Configure your restaurant exactly the way you operate.",
      features: [
    ...
    comparison: {
      heading: "Why Restaurants Choose RESTAURANT360",
      sub: "See how RESTAURANT360 compares to manual operations and basic POS software.",
      cols: ["Capability", "Manual Operation", "Basic POS", "RESTAURANT360"],
      rows: [
        "Fast POS billing",
        "Table-based orders",
        "Non-table orders",
      ...
      cta: "Move from Manual Restaurant Operation to Smart Automation",
    },
    demoForm: {
      heading: "Request a Personalized Demo",
      sub: "Tell us about your restaurant — we'll show you RESTAURANT360 in action.",
      fullName: "Full Name",
    ...
    contact: {
      heading: "Contact Us",
      sub: "Have questions? Our team is here to help.",
  ...
  bn: {
    ...
    hero: {
      ...
      stats: {
        sales: "আজকের সেলস",
        active: "অ্যাকটিভ অর্ডার",
        ready: "কিচেন রেডি",
        lowStock: "লো স্টক অ্যালার্ট",
        pending: "পেন্ডিং সেটেলমেন্ট",
      },
    },
    stats: [
    ...
    homeSections: {
      ...
      featuresTitle: "আপনার রেস্টুরেন্টের সব প্রয়োজন এক জায়গায়",
      featuresSub: "বিলিং, কিচেন, ইনভেন্টরি, অ্যাকাউন্টস ও সেটেলমেন্ট — এক প্ল্যাটফর্মে।",
      whyTitle: "কেন RESTAURANT360",
      whySub: "জেনেরিক রিটেইল নয় — সত্যিকারের রেস্টুরেন্ট অপারেশনের জন্য তৈরি।",
      finalCtaTitle: "আপনার রেস্টুরেন্ট পরিচালনা করুন সম্পূর্ণ নিয়ন্ত্রণের সাথে",
      finalCtaSub: "প্রথম অর্ডার থেকে শেষ সেটেলমেন্ট — সবকিছু সংযুক্ত রাখে RESTAURANT360।",
      finalCtaBtn: "ডেমো চাই",
    },
    modules: [
      { title: "ড্যাশবোর্ড", desc: "ব্যবসার রিয়েল-টাইম স্ন্যাপশট এক নজরে।" },
      { title: "POS (পয়েন্ট অফ সেল)", desc: "যেকোনো আউটলেটের জন্য দ্রুত ও নমনীয় বিলিং।" },
      { title: "টেবিল-ভিত্তিক POS", desc: "টেবিলের সাথে যুক্ত ডাইন-ইন অর্ডার।" },
      { title: "নন-টেবিল POS", desc: "টেকঅ্যাওয়ে ও কাউন্টার সেলসের জন্য।" },
      { title: "অর্ডার ম্যানেজমেন্ট", desc: "পেন্ডিং, অনগোয়িং ও কমপ্লিটেড অর্ডার ট্র্যাক।" },
      { title: "টেবিল ম্যানেজমেন্ট", desc: "টেবিল তৈরি, আপডেট ও স্ট্যাটাস মনিটর।" },
      { title: "কিচেন / KOT", desc: "কিচেনে অর্ডার পাঠান ও ট্র্যাক করুন।" },
      { title: "অনগোয়িং অর্ডার", desc: "চলমান সব অর্ডারের লাইভ ভিউ।" },
      { title: "ফুড ম্যানেজমেন্ট", desc: "খাবারের আইটেম, দাম ও অ্যাভেইলেবিলিটি।" },
      { title: "মেনু ক্যাটাগরি", desc: "দ্রুত সিলেকশনের জন্য ক্যাটাগরি অনুযায়ী সাজান।" },
      { title: "প্রিপেয়ার্ড ফুড", desc: "রেডি-টু-সার্ভ আইটেম ট্র্যাক করুন।" },
      { title: "অ্যাড-অন", desc: "টপিং, এক্সট্রা ও কাস্টমাইজেশন সাপোর্ট।" },
      { title: "ইনভেন্টরি", desc: "স্টক ইন/আউট ও রিয়েল-টাইম স্টক ভিউ।" },
      { title: "র মেটেরিয়াল", desc: "প্রোডাক্ট ও র মেটেরিয়াল ম্যানেজ।" },
      { title: "পারচেজ", desc: "সব পারচেজ রেকর্ড ও ট্র্যাক।" },
      { title: "স্টক ম্যানেজমেন্ট", desc: "স্টক মুভমেন্ট ও অ্যাডজাস্টমেন্ট।" },
      { title: "ইনভেন্টরি ওভারভিউ", desc: "এক স্ক্রিনে সম্পূর্ণ স্টক হেলথ।" },
      { title: "সাপ্লায়ার ম্যানেজমেন্ট", desc: "সাপ্লায়ার ও প্রোকিউরমেন্ট ম্যানেজ।" },
      { title: "HR ম্যানেজমেন্ট", desc: "কর্মী, রোল ও অ্যাকসেস ম্যানেজ।" },
      { title: "অ্যাকাউন্টস ও ফাইন্যান্স", desc: "ইনকাম, এক্সপেন্স ও ফাইন্যান্স কন্ট্রোল।" },
      { title: "ক্যাশ ম্যানেজমেন্ট", desc: "ক্যাশিয়ার-ভিত্তিক ডেইলি কালেকশন।" },
      { title: "ব্যাংক ম্যানেজমেন্ট", desc: "ব্যাংক ডিপোজিট ও ব্যালান্স ট্র্যাক।" },
      { title: "পেমেন্ট মেথড", desc: "ক্যাশ, কার্ড, ব্যাংক ও গেটওয়ে সাপোর্ট।" },
      { title: "সেটেলমেন্ট", desc: "ক্যাশ, ব্যাংক ও গেটওয়ে সেটেলমেন্ট।" },
      { title: "রিপোর্ট ও অ্যানালিটিকস", desc: "সেলস, ইনভেন্টরি ও ফাইন্যান্স রিপোর্ট।" },
      { title: "অ্যাডমিনিস্ট্রেশন", desc: "রোল, পারমিশন ও সিস্টেম সেটআপ।" },
    ],
    why: {
      ...
      benefits: [
        "অর্ডার ভুল কমান",
        "বিলিং দ্রুত করুন",
        "কিচেন সমন্বয় উন্নত করুন",
        "স্টক ভালোভাবে নিয়ন্ত্রণ করুন",
        "সেলস পরিষ্কারভাবে ট্র্যাক করুন",
        "ক্যাশ ও ব্যাংক কালেকশন যাচাই করুন",
        "স্টাফ ও রোল ম্যানেজ করুন",
        "ব্যবসার পূর্ণ ভিজিবিলিটি পান",
      ],
      cta: "আপনার রেস্টুরেন্ট পরিচালনা করুন সম্পূর্ণ নিয়ন্ত্রণের সাথে",
    },
    dashboard: {
      heading: "রিয়েল-টাইম রেস্টুরেন্ট ড্যাশবোর্ড",
      sub: "এক জায়গায় সম্পূর্ণ রেস্টুরেন্টের লাইভ স্ন্যাপশট।",
      features: [
        "রিয়েল-টাইম সেলস অ্যানালিটিকস",
        "ডেইলি সেলস সামারি",
        "বিস্তারিত অর্ডার ইনসাইট",
        "অর্ডার স্ট্যাটাস ওভারভিউ",
        "আইটেম-ভিত্তিক রেভিনিউ ট্র্যাকিং",
        "প্রোডাক্ট স্টক ভিজিবিলিটি",
        "প্রতি আইটেম সেলস কোয়ান্টিটি",
        "ক্যাশ কালেকশন সামারি",
        "পেন্ডিং সেটেলমেন্ট সামারি",
        "সিদ্ধান্ত নেওয়ার জন্য দ্রুত স্ন্যাপশট",
      ],
    },
    pos: {
      heading: "প্রতিটি রেস্টুরেন্টের জন্য দ্রুত POS বিলিং",
      ...
      capabilities: [
        "দ্রুত অর্ডার তৈরি",
        "অর্ডার মডিফিকেশন",
        "ডায়নামিক আইটেম সিলেকশন",
        "অ্যাড-অন সাপোর্ট",
        "রিয়েল-টাইম বিল ক্যালকুলেশন",
        "ভ্যাট ক্যালকুলেশন",
        "সার্ভিস চার্জ ক্যালকুলেশন",
        "ডিসকাউন্ট ক্যালকুলেশন",
        "পেমেন্ট প্রসেসিং",
        "পেমেন্ট মেথড সিলেকশন",
        "ক্যাশ, কার্ড, ব্যাংক ও গেটওয়ে সাপোর্ট",
      ],
    },
    orderManagement: {
      heading: "সম্পূর্ণ অর্ডার লাইফসাইকেল ম্যানেজমেন্ট",
      sub: "প্রথম ট্যাপ থেকে শেষ পেমেন্ট — প্রতিটি অর্ডার ট্র্যাক।",
      features: [
        "POS-ইন্টিগ্রেটেড অর্ডার ভিউ",
        "পেন্ডিং, অনগোয়িং ও কমপ্লিটেড অর্ডার ফিল্টার",
        "টেবিল-ভিত্তিক অর্ডার ট্র্যাকিং",
        "অ্যাকটিভ অর্ডার মডিফিকেশন",
        "কমপ্লিশনের আগে আইটেম যোগ/বাদ",
        "পেমেন্ট প্রসেসিং",
        "পেমেন্ট মেথড ট্র্যাকিং",
    ...
    kitchenKot: {
      ...
      sub: "কিচেনে অর্ডার পাঠান এবং রিয়েল-টাইমে প্রস্তুতি ট্র্যাক করুন।",
      flow: ["অর্ডার তৈরি", "কিচেনে পাঠানো", "প্রস্তুত হচ্ছে", "রেডি", "সার্ভড", "পেমেন্ট সম্পন্ন"],
      features: [
        "কিচেনে অর্ডার পাঠান",
        "প্রস্তুতি স্ট্যাটাস ট্র্যাক",
        "অর্ডার অগ্রগতি আপডেট",
        "কিচেন ডিসপ্লে স্টাইল ইন্টারফেস",
        "যোগাযোগের ভুল কমান",
        "সার্ভিস স্পিড উন্নত করুন",
        "প্রিপেয়ারিং, রেডি ও সার্ভড স্ট্যাটাস",
      ],
    },
    foodManagement: {
      heading: "ফুড, মেনু এবং অ্যাড-অন ম্যানেজমেন্ট",
      sub: "আপনার রেস্টুরেন্ট যেভাবে চলে সেভাবেই মেনু সাজান।",
      features: [
        "ফুড আইটেম CRUD",
        "মেনু ক্যাটাগরি ম্যানেজমেন্ট",
        "ফুড প্রাইসিং ম্যানেজমেন্ট",
        "ফুড অ্যাভেইলেবিলিটি কন্ট্রোল",
        "প্রিপেয়ার্ড ফুড ম্যানেজমেন্ট",
        "অ্যাড-অন ও এক্সট্রা",
        "নমনীয় টপিং ও কাস্টমাইজেশন",
        "সহজ মেনু স্ট্রাকচার",
      ],
    },
    inventory: {
      heading: "স্মার্ট ইনভেন্টরি ও স্টক কন্ট্রোল",
      sub: "পারচেজ থেকে প্লেট পর্যন্ত প্রতিটি র মেটেরিয়াল ট্র্যাক করুন।",
      features: [
        "প্রোডাক্ট / র মেটেরিয়াল ম্যানেজমেন্ট",
        "পারচেজ রেকর্ডিং",
        "স্টক ইন / স্টক আউট",
    ...
    accounts: {
      ...
      sub: "সেলস, পারচেজ ও পেমেন্ট সরাসরি ফাইন্যান্সের সাথে যুক্ত।",
      features: [
        "ইনকাম ট্র্যাকিং",
        "এক্সপেন্স ট্র্যাকিং",
        ...
        "সেলস ইন্টিগ্রেশন",
        "পারচেজ ইন্টিগ্রেশন",
        "ফাইন্যান্সিয়াল রেকর্ড কিপিং",
        "ডেইলি ফাইন্যান্সিয়াল সামারি",
        "প্রফিটেবিলিটি ভিজিবিলিটি",
        "ক্যাশ কালেকশন ট্র্যাকিং",
        "ব্যাংক কালেকশন ট্র্যাকিং",
        "কার্ড / গেটওয়ে কালেকশন ট্র্যাকিং",
        "পেমেন্ট মেথড-ভিত্তিক সামারি",
        "ক্যাশ হ্যান্ডওভার",
        "ব্যাংক ডিপোজিট ট্র্যাকিং",
        "গেটওয়ে সেটেলমেন্ট",
        "সেটেলমেন্ট ব্যাচ ম্যানেজমেন্ট",
        "সেটেলমেন্ট চার্জ ট্র্যাকিং",
        "ডেইলি ক্লোজিং সেটেলমেন্ট",
      ],
    },
    settlement: {
      heading: "ক্যাশ, ব্যাংক ও সেটেলমেন্ট কন্ট্রোল",
      sub: "RESTAURANT360 রেস্টুরেন্টের daily cash collection, bank payment, card/gateway payment এবং settlement status পরিষ্কারভাবে track করতে সাহায্য করে। Daily operation close করার আগে manager cash, bank এবং online payment collection verify করতে পারে।",
      features: [
        "ক্যাশ কালেকশন ট্র্যাকিং",
        "ব্যাংক পেমেন্ট ট্র্যাকিং",
        "কার্ড পেমেন্ট ট্র্যাকিং",
        "মোবাইল ব্যাংকিং / গেটওয়ে পেমেন্ট ট্র্যাকিং",
        "পেমেন্ট মেথড-ভিত্তিক কালেকশন সামারি",
        "ক্যাশ হ্যান্ডওভার ট্র্যাকিং",
        "ক্যাশ vs সিস্টেম কালেকশন ভেরিফিকেশন",
        "ব্যাংক ডিপোজিট ট্র্যাকিং",
        "গেটওয়ে সেটেলমেন্ট ট্র্যাকিং",
        "পেন্ডিং সেটেলমেন্ট লিস্ট",
        "সেটেলড পেমেন্ট লিস্ট",
        "সেটেলমেন্ট ব্যাচ ম্যানেজমেন্ট",
        "সেটেলমেন্ট ডেট ট্র্যাকিং",
        "রেফারেন্স নাম্বার ট্র্যাকিং",
        "ব্যাংক চার্জ / গেটওয়ে চার্জ ট্র্যাকিং",
        "ডেইলি ক্লোজিং সেটেলমেন্ট সামারি",
        "ক্যাশিয়ার-ভিত্তিক সেটেলমেন্ট রিপোর্ট",
        "পেমেন্ট মেথড-ভিত্তিক সেটেলমেন্ট রিপোর্ট",
    ...
    reports: {
      ...
      sub: "যখন প্রয়োজন তখন প্রয়োজনীয় সব নাম্বার।",
      list: [
        "ডেইলি সেলস রিপোর্ট",
        "মান্থলি সেলস রিপোর্ট",
        "কাস্টম ডেট রেঞ্জ সেলস রিপোর্ট",
        "প্রোডাক্ট পারফরম্যান্স রিপোর্ট",
        "আইটেম-ভিত্তিক সেলস কোয়ান্টিটি রিপোর্ট",
        "ইনভেন্টরি রিপোর্ট",
        "পারচেজ রিপোর্ট",
        "সাপ্লায়ার রিপোর্ট",
        ...
        "ব্যাংক কালেকশন রিপোর্ট",
        "পেমেন্ট মেথড-ভিত্তিক কালেকশন রিপোর্ট",
        "গেটওয়ে সেটেলমেন্ট রিপোর্ট",
        "ব্যাংক সেটেলমেন্ট রিপোর্ট",
        "পেন্ডিং সেটেলমেন্ট রিপোর্ট",
        "ক্যাশিয়ার-ভিত্তিক কালেকশন রিপোর্ট",
        "ডেইলি ক্লোজিং রিপোর্ট",
      ],
    },
    administration: {
      heading: "অ্যাডমিনিস্ট্রেশন ও সিস্টেম কন্ট্রোল",
      sub: "আপনার রেস্টুরেন্ট ঠিক যেভাবে চলে সেভাবেই কনফিগার করুন।",
      features: [
        "রোল-ভিত্তিক পারমিশন",
        "ইউজার অ্যাকসেস কন্ট্রোল",
        "সিস্টেম সেটিংস",
        "ভ্যাট সেটআপ",
        "সার্ভিস চার্জ সেটআপ",
        "ডিসকাউন্ট সেটআপ",
        "টেবিল অর্ডার এনাবল / ডিজেবল",
        "রেস্টুরেন্ট কনফিগারেশন",
        "পেমেন্ট মেথড কনফিগারেশন",
        "ক্যাশিয়ার অ্যাকসেস কন্ট্রোল",
      ],
    },
    comparison: {
      heading: "রেস্টুরেন্টগুলো কেন RESTAURANT360 বেছে নেয়",
      sub: "ম্যানুয়াল অপারেশন ও বেসিক POS এর সাথে RESTAURANT360 এর তুলনা।",
      cols: ["সক্ষমতা", "ম্যানুয়াল অপারেশন", "বেসিক POS", "RESTAURANT360"],
      rows: [
        "দ্রুত POS বিলিং",
        "টেবিল-ভিত্তিক অর্ডার",
        "নন-টেবিল অর্ডার",
        "কিচেন অর্ডার ট্র্যাকিং",
        "ফুড / মেনু ম্যানেজমেন্ট",
        "অ্যাড-অন সাপোর্ট",
        "ইনভেন্টরি কন্ট্রোল",
        ...
        "ব্যাংক সেটেলমেন্ট",
        "গেটওয়ে সেটেলমেন্ট",
        "পেমেন্ট মেথড-ভিত্তিক কালেকশন",
        "ডেইলি ক্লোজিং সেটেলমেন্ট",
        "সেলস রিপোর্ট",
        "প্রোডাক্ট পারফরম্যান্স রিপোর্ট",
        "রোল-ভিত্তিক পারমিশন",
        "ভ্যাট / সার্ভিস চার্জ / ডিসকাউন্ট সেটিংস",
        "বিজনেস ড্যাশবোর্ড",
      ],
      cta: "ম্যানুয়াল রেস্টুরেন্ট অপারেশন থেকে স্মার্ট অটোমেশনে যান",
    },
    demoForm: {
      heading: "পার্সোনালাইজড ডেমো রিকোয়েস্ট করুন",
      sub: "আপনার রেস্টুরেন্ট সম্পর্কে বলুন — আমরা RESTAURANT360 দেখাবো।",
      fullName: "পূর্ণ নাম",
      restaurantName: "রেস্টুরেন্টের নাম",
      businessType: "ব্যবসার ধরন",
      email: "ইমেইল",
      phone: "ফোন",
      outlets: "আউটলেট সংখ্যা",
      message: "মেসেজ",
      ...
      placeholders: {
        ...
        restaurantName: "আপনার রেস্টুরেন্টের নাম",
        businessType: "রেস্টুরেন্ট / ক্যাফে / ক্লাউড কিচেন",
        email: "you@example.com",
        phone: "+8801XXXXXXXXX",
        outlets: "যেমন ২",
    ...
    contact: {
      ...
      sub: "প্রশ্ন আছে? আমাদের টিম সাহায্য করতে প্রস্তুত।",

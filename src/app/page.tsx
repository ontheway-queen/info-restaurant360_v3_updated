...
export default function Page() {
  ...
  return (
    <>
      ...
      <Section title={t.homeSections.whyTitle} subtitle={t.homeSections.whySub}>
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {t.why.benefits.map((b, i) => (
            ...
            >
              <div className="mb-2 inline-flex mr-2 h-7 w-7 items-center justify-center rounded-full bg-primary/15 text-xs font-bold text-primary">
                {i + 1}
              </div>
              {b}
            </motion.div>
      ...
      <CTASection
        title={t.homeSections.finalCtaTitle}
        subtitle={t.homeSections.finalCtaSub}
        ctaLabel={t.homeSections.finalCtaBtn}
      />
    </>
  );
}

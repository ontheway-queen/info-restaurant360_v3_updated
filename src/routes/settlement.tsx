...
export const Route = createFileRoute("/settlement")({ component: SettlementPage });

function SettlementPage() {
  const { t } = useLanguage();
  return (
    <>
      <SEOHead title={t.seo.settlement.title} description={t.seo.settlement.description} path="/settlement" />

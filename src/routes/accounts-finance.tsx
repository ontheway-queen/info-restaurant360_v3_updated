...
export const Route = createFileRoute("/accounts-finance")({ component: AccountsPage });

function AccountsPage() {
  const { t } = useLanguage();
  return (
    <>
      <SEOHead title={t.seo.accounts.title} description={t.seo.accounts.description} path="/accounts-finance" />
